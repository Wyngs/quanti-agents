...
/**
 * wrapper so I can reuse the same auth flow everywhere without duplicating logic.
 */
public class LoginService {
    ...
    @Nullable
    /**
     * Returns the cached user if already logged in, falling back to a synchronous lookup.
     */
